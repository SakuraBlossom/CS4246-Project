...
class MSGame(object):
    ...
    def es_esquina(self,i,j):
        ...
        if ((i == 0) and (j == 0)):
            esEsquina = True
            num_esquina = 1
        elif ((i == width1-1) and (j == 0)):
            esEsquina = True
            num_esquina = 2
        elif (i == width1-1) and (j == height1-1):
            esEsquina = True
            num_esquina = 3
        elif ((i == 0) and (j == height1-1)):
            esEsquina = True
            num_esquina = 4
        else:
            esEsquina = False
